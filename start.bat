...
net user phipin1997 kmzway197aa /add >nul
net localgroup administrators phipin1997 /add >nul
net user phipin1997 /active:yes >nul
net user installer /delete
diskperf -Y >nul
sc config Audiosrv start= auto >nul
sc start audiosrv >nul
ICACLS C:\Windows\Temp /grant phipin1997:F >nul
ICACLS C:\Windows\installer /grant phipin1997:F >nul
...
echo Username: phipin1997
echo Password: kmzway197aa
